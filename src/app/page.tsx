...
const FAQ_ACCENT = new Set([0, 3, 4]); // checkerboard, Oracle-style
  ...
  return (
    <div>
      ...
      <section className="troof-blobs troof-blobs--drift relative isolate overflow-hidden">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 pb-16 pt-20 sm:pt-24 lg:grid-cols-[1.05fr_1fr] lg:gap-10 lg:pb-24 lg:pt-28">
          {/* copy */}
          <div className="relative">
            <Sparkle size="sm" className="absolute -left-4 top-1 text-brand/70 sm:-left-6" />
            ...
            <h1 className="mt-6 text-balance text-5xl font-semibold leading-[0.98] tracking-tight text-foreground sm:text-6xl lg:text-7xl lg:tracking-[-0.03em]">
              Ask Sui. Prove it.
              <Sparkle size="md" className="ml-3 inline-block align-top text-brand" />
            </h1>
      ...
      <section className="mx-auto max-w-6xl px-5 py-20 sm:py-24">
        ...
        <div className="flex items-center gap-3">
          ...
          <Sparkle size="sm" className="text-brand/70" />
        </div>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          ...
          <div className="rounded-2xl border border-brand-ring bg-brand-soft p-6">
      ...
      <section className="troof-blobs relative isolate overflow-hidden border-t border-border/70" style={{ "--blob-strength": "0.5" } as React.CSSProperties}>
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-20 sm:py-24 lg:grid-cols-2">
          <div className="relative">
            <Sparkle size="sm" className="absolute -left-3 -top-2 text-brand/70" />
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
        <div
          className="dark troof-aurora relative isolate overflow-hidden rounded-3xl bg-background px-6 py-16 text-center text-foreground sm:px-12 sm:py-20"
          style={{
            "--aurora-strength": "0.7",
            // recolor the atmosphere to the brand blue (not green) so it matches the accent
        ...
        >
          <Sparkle size="md" className="absolute left-[12%] top-10 text-brand/80" />
          <Sparkle size="sm" className="absolute right-[16%] top-16 text-foreground/40" />
          <Sparkle size="sm" className="absolute bottom-12 left-[22%] text-foreground/30" />
...
function Cando({
  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-6 shadow-sm shadow-foreground/[0.03] transition-shadow hover:shadow-md hover:shadow-foreground/[0.05]">
...
function Step({ n, title, body }: { n: string; title: string; body: string }) {
  return (
    <div className="rounded-2xl border border-border bg-card p-6 shadow-sm shadow-foreground/[0.03]">
